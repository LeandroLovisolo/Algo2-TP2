...
\begin{Algoritmos}
  ...
  \begin{Algoritmo}{iAgregarLink}{\In{l}{link}, \In{c}{categoria}, \Inout{s}{estr\_sistema}}{}{$\Theta(|c| + |l| + h)$}{
    ...
    $\Theta(|c|) + \Theta(|l|)\ + h * (\Theta(1) + \Theta(1) + \Theta(1)) =$ \hfill $h$ es la altura del árbol de categorías. \\
