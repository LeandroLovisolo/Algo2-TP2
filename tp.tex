...
\begin{Algoritmos}
  ...
  \begin{Algoritmo}{iCrearSistema}{\In{ac}{estr\_acat}}{estr\_sistema}{$\Theta(\#(categorias(ac)))$}{
    $\Theta(1) + \Theta(1) + \Theta(\#categorias(ac)) + \Theta(1) + \Theta(1) + \Theta(1) + \Theta(1) + \Theta(1) + \Theta(1) + \Theta(\#categorias(ac)) =$ \\
    $8 * \Theta(1) + 2 * \Theta(\#categorias(ac)) =$ \\
    $2 * \Theta(\#categorias(ac)) =$ \\
    $\Theta(\#categorias(ac)).$ \\    
  }
    ...
    \STATE \NombreFuncion{iAgregarALinksPorCatId(CrearItRaíz($ac$), 1, $res$)}  \CompTheta{$\#categorias(ac)$}
  \end{Algoritmo}
