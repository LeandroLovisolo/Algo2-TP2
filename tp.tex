...
\begin{Algoritmos}
  ...
  \begin{Algoritmo}{iCrearIterLinks}{\In{c}{categoría}, \In{s}{estr\_sistema}}{estr\_iter}
    \STATE var $estr\_c$: \TipoVariable{estr\_linksPorCatId}
  	...
  	\IF{$¬$($estr\_c$.ordenado?)}
  	  ...
  	  \WHILE{\NombreFuncion{HaySiguiente}($itRecorreredor$)} \IF{(AccesosRecientes(*(\NombreFuncion{Siguiente}($itRecorredor$)), $estr\_c$.últimoAcceso) > \\ (AccesosRecientes(*($maxPointer$), $estr\_c$.últimoAcceso)}
  ...
  \begin{Algoritmo}{iAccesosRecientes}{\In{estr\_l}{estr\_link}, \In{ultimoAccesoASistema}{nat}}{nat}
