...
\begin{Interfaz}
  ...
  \InterfazFuncion{CrearIt}{\In{padre}{categoria}, \In{ac}{acat}}{itcat}
  [está?($padre$, $ac$)]
  ...
  \InterfazFuncion{CrearItRaíz}{\In{ac}{acat}}{itcat}
  ...
  \InterfazFuncion{CrearItDadoOtroIt}{\In{it}{itcat}, \In{ac}{acat}}{itcat}
  [HayMás?($it$)]
...
\begin{Interfaz}
  ...
  \InterfazFuncion{CrearIt}{\In{c}{categoría}, \In{s}{sistema}}{iterlinks}
  [está?($c$, categorías($s$))]
