...
\begin{Algoritmos}
  ...
  \begin{Algoritmo}{iAgregarLink}{\In{l}{link}, \In{c}{categoria}, \Inout{s}{estr\_sistema}}{}
    ...
    \STATE $cid$ $\leftarrow$ $estr\_l$.cid
 	\STATE var $ptrEstr\_l$: \TipoVariable{puntero(estr\_link)} $\leftarrow$  \&(\NombreFuncion{Obtener}($l$, $s$.links))
 	\WHILE{$¬$($cid$ $\igobs$ 0)}
      \STATE \NombreFuncion{AgregarAtrás}($s$.linksPorCatId[$cid$ - 1].links, $ptrEstr\_l$)
